...
namespace SpiritMod.Tiles.MusicBox
{
	internal class CrimsonNightBox : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.MusicBox.CrimsonNightBox>();
		}

		public override bool CanDrop(int i, int j) => false;

		public override void KillMultiTile(int i, int j, int frameX, int frameY)
			=> Item.NewItem(null, new Rectangle(i * 16, j * 16, 32, 32), new Item(ModContent.ItemType<Items.Placeable.MusicBox.CrimsonNightBox>()), false, true);

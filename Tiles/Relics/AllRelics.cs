namespace SpiritMod.Tiles.Relics
{
	...
	public class RlyehianRelic : BaseRelic<Items.Placeable.Relics.RlyehianRelicItem> { }
	public class StarplateRelic : BaseRelic<Items.Placeable.Relics.StarplateRelicItem> { }
}

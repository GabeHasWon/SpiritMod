...
namespace SpiritMod.Tiles.Ambient.GraniteSpike
{
	public class Spike4Tile : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<GraniteSpike4>());
	}
}
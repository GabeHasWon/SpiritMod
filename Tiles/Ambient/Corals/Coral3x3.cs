...
namespace SpiritMod.Tiles.Ambient.Corals
{
	public class Coral3x3 : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ItemID.Coral, Main.rand.Next(5, 9));
	}
}

...
public class AuroraOverlay(EffectPriority priority = EffectPriority.High, RenderLayers layer = RenderLayers.Sky) : Overlay(priority, layer)
{
	...
	private void DrawAurora(SpriteBatch spriteBatch)
	{
		...
		if (ActiveAurora(UNUSED_BASIC, out float i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(137, 48, 255), new Color(125, 0, 255), 0.0031f, 0.8f * i, 0.2f);
			DrawSingularAurora(spriteBatch, basePoint, 20, Height, new Color(0, 143, 233), new Color(0, 255, 255), 0.0031f, 1f * i, 0.32f);
		}

		if (ActiveAurora(PRIMARY, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 20, Height + 100, new Color(0, 143, 233), new Color(0, 255, 255), 0.0031f, 1f * i, 0.1f);
			DrawSingularAurora(spriteBatch, basePoint, 0, Height + 100, new Color(60, 200, 183), new Color(0, 255, 100), 0.0031f, 1f * i, 0.4f);
		}

		if (ActiveAurora(PRIMARY_ALT1, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 20, Height, new Color(0, 143, 233), new Color(0, 255, 255), 0.0031f, 1f * i, 0.1f);
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(60, 200, 183), new Color(0, 255, 100), 0.0031f, 1f * i, 0.4f);
		}
		
		if (ActiveAurora(PRIMARY_ALT2, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 20, Height, new Color(0, 143, 233), new Color(0, 255, 255), 0.0031f, 1f * i, 0.1f);
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(60, 200, 183), new Color(0, 255, 100), 0.0031f, 1f * i, 0.43f);
		}
		
		if (ActiveAurora(PRIMARY_ALT3, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(137, 48, 255), new Color(125, 0, 255), 0.0031f, 0.8f * i, 0.2f);
			DrawSingularAurora(spriteBatch, basePoint, 20, Height, new Color(0, 143, 233), new Color(0, 255, 255), 0.0031f, 1f * i, 0.32f);
		}
		
		if (ActiveAurora(BLOODMOON, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(247, 39, 67), new Color(206, 51, 72), 0.0031f, 0.8f * i, 0.1f);
			DrawSingularAurora(spriteBatch, basePoint, 20, Height, new Color(252, 42, 186), new Color(143, 15, 155), 0.0031f, 1f * i, 0.32f);
		}
		
		if (ActiveAurora(PUMPKINMOON, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 20, Height, new Color(255, 170, 114), new Color(255, 170, 114), 0.0028f, 0.8f * i, 0.2f);
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(255, 195, 56), new Color(255, 195, 56), 0.0028f, 0.8f * i, 0.17f);
		}
		
		if (ActiveAurora(FROSTMOON, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 0, Height + 200, new Color(124, 142, 255), new Color(124, 142, 255), 0.0028f, 0.8f * i, 0.1f);
			DrawSingularAurora(spriteBatch, basePoint, 20, Height + 200, new Color(127, 255, 250), new Color(127, 255, 250), 0.0028f, 0.8f * i, 0.37f);
		}
		
		if (ActiveAurora(BLUEMOON, out i))
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(255, 156, 197), new Color(255, 223, 153), 0.0028f, 0.8f * i, 0.1f);
		
		if (ActiveAurora(SPIRIT, out i))
		{
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(137, 48, 255), new Color(125, 0, 255), 0.0031f, 0.8f * i, 0.2f);
			DrawSingularAurora(spriteBatch, basePoint, 0, Height, new Color(91, 69, 255), new Color(86, 33, 209), 0.0031f, 0.8f * i, 0.3f);
		}

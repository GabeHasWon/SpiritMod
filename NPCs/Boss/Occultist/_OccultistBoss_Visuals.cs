...
public partial class OccultistBoss : IDrawAdditive
{
	...
	{
		Color glowColor = Color.Lerp(Color.Red, Color.Magenta, DrawTimer) with { A = 0 };
		...
		spriteBatch.Draw(bloom, NPC.Center - screenPos, null, Color.White with { A = 0 } * _whiteGlow * 0.8f, 0, bloom.Size() / 2, 0.5f, SpriteEffects.None, 0);

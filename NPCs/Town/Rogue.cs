...
namespace SpiritMod.NPCs.Town
{
	...
	public class Rogue : ModNPC
	{
		...
		public override List<string> SetNPCNameList()
		{
			...
			for (int i = 1; i < 9; i++)
				nameList.Add(Language.GetTextValue("Mods.SpiritMod.NPCs.Rogue.Names." + i));
		...
		public override string GetChat()
		{
			...
			for (int i = 1; i < 8; i++)
				dialogue.Add(Language.GetTextValue("Mods.SpiritMod.NPCs.Rogue.Dialogue.Basic" + i));

			int wizard = NPC.FindFirstNPC(NPCID.Wizard);
			if (wizard >= 0)
				dialogue.Add(Language.GetTextValue("Mods.SpiritMod.NPCs.Rogue.Dialogue.Special1", Main.npc[wizard].GivenName));

			int merchant = NPC.FindFirstNPC(NPCID.Merchant);
			if (merchant >= 0)
				dialogue.Add(Language.GetTextValue("Mods.SpiritMod.NPCs.Rogue.Dialogue.Special2", Main.npc[merchant].GivenName));

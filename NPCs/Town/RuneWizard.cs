...
namespace SpiritMod.NPCs.Town
{
	...
	public class RuneWizard : ModNPC
	{
		...
		public override List<string> SetNPCNameList()
		{
			...
			for (int i = 1; i < 9; i++)
				nameList.Add(Language.GetTextValue("Mods.SpiritMod.NPCs.RuneWizard.Names." + i));
		...
		public override string GetChat()
		{
			...
			for (int i = 1; i < 8; i++)
				dialogue.Add(Language.GetTextValue("Mods.SpiritMod.NPCs.RuneWizard.Dialogue.Basic" + i));

			dialogue.AddWithCondition(Language.GetTextValue("Mods.SpiritMod.NPCs.RuneWizard.Dialogue.Special1"), MyWorld.blueMoon);
			dialogue.AddWithCondition(Language.GetTextValue("Mods.SpiritMod.NPCs.RuneWizard.Dialogue.Special2"), Main.hardMode);

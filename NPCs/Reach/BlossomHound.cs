...
namespace SpiritMod.NPCs.Reach
{
	public class BlossomHound : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			return (spawnInfo.Player.ZoneBriar() && player.ZoneOverworldHeight && !(player.ZoneTowerSolar || player.ZoneTowerVortex || 
		...
		{
			for (int k = 0; k < 20; k++)
				Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Plantera_Green, hit.HitDirection * 2.5f, -1f, 0, default, Main.rand.NextFloat(.45f, 1.15f));

...
namespace SpiritMod.NPCs.WinterbornHerald
{
	public class WinterbornMagic : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) => NPC.downedBoss3 && spawnInfo.SpawnTileY > Main.rockLayer && 
			spawnInfo.Player.ZoneSnow && !spawnInfo.Player.ZoneDungeon && !spawnInfo.PlayerInTown ? 0.035f : 0f;

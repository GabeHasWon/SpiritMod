...
namespace SpiritMod.NPCs.CavernBandit
{
	public class CavernBandit : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) => !(spawnInfo.Player.ZoneDungeon || spawnInfo.Player.ZoneSnow) ? SpawnCondition.Cavern.Chance * 0.0234f : 0f;

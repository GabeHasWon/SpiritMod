...
namespace SpiritMod.Items.BossLoot.ScarabeusDrops
{
	public class Trophy1Tile : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 48, ModContent.ItemType<Trophy1>());
	}
}
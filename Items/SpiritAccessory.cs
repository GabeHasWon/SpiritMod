...
public abstract class SpiritAccessory : SpiritItem
{
	...
	public List<SpiritPlayerEffect> _accEffects;

	public virtual List<int> MutualExclusives => new List<int>();
	public List<int> _mutExclusives;
	...
	{
		SpiritAccessory spirit = base.Clone(newEntity) as SpiritAccessory;
		spirit._accEffects = _accEffects;
		spirit._mutExclusives = _mutExclusives;
		return spirit;
	}

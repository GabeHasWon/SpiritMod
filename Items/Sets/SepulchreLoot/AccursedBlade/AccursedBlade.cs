...
namespace SpiritMod.Items.Sets.SepulchreLoot.AccursedBlade
{
	public class AccursedBlade : ModItem
	{
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI) => GlowmaskUtils.DrawItemGlowMaskWorld(Main.spriteBatch, Item, Mod.Assets.Request<Texture2D>(Texture.Remove(0, Mod.Name.Length + 1) + "_glow").Value, rotation, scale);
	...
	public class AccursedSoul : ModItem
	{
		...
		public override void GrabRange(Player player, ref int grabRange) => grabRange = 10;

		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			if (Projectile.ai[0] == 1) { 
				for(int i = 0; i < ProjectileID.Sets.TrailCacheLength[Projectile.type]; i++)
				{
					...
					Main.EntitySpriteDraw(drawTex, Projectile.oldPos[i] + (Projectile.Size / 2) - Main.screenPosition, Projectile.DrawFrame(), trailColor * opacity, Projectile.oldRot[i], 
			...
			Main.EntitySpriteDraw(drawTex, Projectile.Center - Main.screenPosition, Projectile.DrawFrame(), lightColor * Projectile.Opacity, Projectile.rotation, Projectile.DrawFrame().Size() / 2, 

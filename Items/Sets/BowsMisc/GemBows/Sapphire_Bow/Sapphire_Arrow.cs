...
namespace SpiritMod.Items.Sets.BowsMisc.GemBows.Sapphire_Bow
{
	public class Sapphire_Arrow : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int i = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GemSapphire, 0.0f, 0.0f, 0, Color.Blue, 1f);

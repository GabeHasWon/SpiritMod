...
namespace SpiritMod.Items.Sets.BowsMisc.GemBows.Topaz_Bow
{
	public class Topaz_Arrow : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int i = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GemTopaz, 0.0f, 0.0f, 0, Color.Yellow, 1f);

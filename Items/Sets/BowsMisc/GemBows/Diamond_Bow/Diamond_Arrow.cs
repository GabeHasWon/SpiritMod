...
namespace SpiritMod.Items.Sets.BowsMisc.GemBows.Diamond_Bow
{
	public class Diamond_Arrow : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int i = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GemDiamond, 0.0f, 0.0f, 0, Color.White, 1f);

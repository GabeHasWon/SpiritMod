...
{
	public class StarshotBlue : ModProjectile, ITrailProjectile
	{
		public void DoTrailCreation(TrailManager tManager) => tManager.CreateTrail(Projectile, new GradientTrail(Color.LightBlue, Color.DarkBlue), new NoCap(), new DefaultTrailPosition(), 8f, 300f, new DefaultShader());

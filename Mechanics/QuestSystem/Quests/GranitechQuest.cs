...
namespace SpiritMod.Mechanics.QuestSystem.Quests
{
	public class GranitechQuest : Quest
	{
		...
		{
			_tasks.AddParallelTasks(new SlayTask(ModContent.NPCType<NPCs.GraniTech.GraniteSentry>(), 3), new RetrievalTask(ModContent.ItemType<Items.Sets.GranitechSet.GranitechMaterial>(), 10, "Retrieve"))

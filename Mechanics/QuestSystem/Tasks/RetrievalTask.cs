...
namespace SpiritMod.Mechanics.QuestSystem.Tasks
{
	public class RetrievalTask : QuestTask
	{
		...
		public RetrievalTask(int itemID, int amount, LocalizedText wordChoice = null, string objectiveKey = null)
		{
			_itemID = itemID;
			_itemsNeeded = amount;
			_wording = wordChoice ?? QuestManager.Localization("Retrieve");
			_objective = objectiveKey is not null ? QuestManager.Localization(objectiveKey) : null;
		}

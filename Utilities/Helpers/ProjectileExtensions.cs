...
namespace SpiritMod
{
	public static class ProjectileExtensions
	{
		...
		public static void QuickDraw(this Projectile projectile, SpriteBatch spriteBatch = null, float? rotation = null, SpriteEffects? spriteEffects = null, Color? drawColor = null, Vector2? drawOrigin = null)
		{
		...
		public static void QuickDrawGlow(this Projectile projectile, SpriteBatch spriteBatch = null, Color? color = null, float? rotation = null, SpriteEffects? spriteEffects = null, Vector2? drawOrigin = null)
		{
			...
			if (spriteBatch == null)
				Main.EntitySpriteDraw(tex, projectile.Center - Main.screenPosition, frame, color ?? Color.White, rotation ?? projectile.rotation, drawOrigin ?? frame.Size() / 2, projectile.scale, 
		...
		public static void QuickDrawTrail(this Projectile projectile, SpriteBatch spriteBatch = null, float baseOpacity = 0.5f, float? rotation = null, SpriteEffects? spriteEffects = null, Color? drawColor = null, Vector2? drawOrigin = null)
		{
			Texture2D tex = TextureAssets.Projectile[projectile.type].Value;
			Color color = drawColor ?? Lighting.GetColor((int)projectile.Center.X / 16, (int)projectile.Center.Y / 16);
			if (spriteEffects == null)
		...
		public static void QuickDrawGlowTrail(this Projectile projectile, SpriteBatch spriteBatch = null, float Opacity = 0.5f, Color? color = null, float? rotation = null, SpriteEffects? spriteEffects = null, Vector2? drawOrigin = null)
		{
			if (!ModContent.HasAsset(projectile.ModProjectile.Texture + "_Glow"))
				return;
			...
			for (int i = 0; i < ProjectileID.Sets.TrailCacheLength[projectile.type]; i++)
			{
				...
				if (spriteBatch == null)
					Main.EntitySpriteDraw(tex, projectile.oldPos[i] + projectile.Size / 2 - Main.screenPosition, frame, (color ?? Color.White) * opacity, rotation ?? projectile.oldRot[i], 

	...
	public class HallowedStaffProj : ModProjectile, ITrailProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.localAI[0] >= 10f)
			{
				...
				{
					if (Main.projectile[num420].active && Main.projectile[num420].owner == Projectile.owner && Main.projectile[num420].type == Projectile.type && Main.projectile[num420].ai[1] < 3600f)
					{
						num416++;
		...
		public override Color? GetAlpha(Color lightColor) => new Color(100 + colortimer, 60 + colortimer, 100 + colortimer, 100);
	}
}

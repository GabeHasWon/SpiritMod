...
namespace SpiritMod.Projectiles.Magic
{
	public class PalladiumStaffProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (effectTimer >= 22)
			{
				int p = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X + Main.rand.Next(-27, 17), Projectile.Center.Y + 22, Projectile.velocity.X + Main.rand.Next(-2, 2), Projectile.velocity.Y + Main.rand.Next(-2, -1), ModContent.ProjectileType<PalladiumRuneEffect>(), Projectile.damage, 0, Projectile.owner, 0f, 0f);

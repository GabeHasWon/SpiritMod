	...
	public class GobSorcererOrb : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_Death(), pos.X, pos.Y, velocity.X, velocity.Y, ModContent.ProjectileType<ShadowflameOrbBolt>(), Projectile.damage, Projectile.knockBack, Projectile.owner);

	...
	public class StarSoul : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (++Projectile.localAI[0] >= 10f)
			{
				...
				if (countOtherProjectiles > 8)
				{
					Main.projectile[otherWhoAmI].netUpdate = true;
					Main.projectile[otherWhoAmI].ai[1] = 36000f;
					return;
				}
			}
		}

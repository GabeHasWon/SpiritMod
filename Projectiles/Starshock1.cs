...
namespace SpiritMod.Projectiles
{
	public class Starshock1 : ModProjectile, ITrailProjectile
    {
		...
		{
			tManager.CreateTrail(Projectile, new GradientTrail(new Color(108, 215, 245), new Color(105, 213, 255)), new RoundCap(), new DefaultTrailPosition(), 50f, 150f, new ImageShader(Mod.Assets.Request<Texture2D>("Textures/Trails/Trail_4", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value, 0.01f, 1f, 1f));

...
namespace SpiritMod.Projectiles
{
	class WildMagic : ModProjectile
	{
		...
		public override void OnKill(int timeLeft) => Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.GoldCoin, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f);

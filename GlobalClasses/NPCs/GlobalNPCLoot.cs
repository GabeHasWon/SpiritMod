...
namespace SpiritMod.GlobalClasses.NPCs
{
	internal class GlobalNPCLoot : GlobalNPC
	{
		...
		public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
		{
			...
			DropLoot(npcLoot, 50, 50, ModContent.ItemType<Items.Weapon.Summon.EngineeringRod>(), npc, NPCID.GrayGrunt, NPCID.RayGunner, NPCID.BrainScrambler);
			...
			DropLoot(npcLoot, 100, 100, ModContent.ItemType<Items.Sets.SlingHammerSubclass.PossessedHammer>(), npc, NPCID.PossessedArmor);
			...
			DropLoot(npcLoot, 2, 2, ModContent.ItemType<Items.Material.OldLeather>(), 1, 2, npc, NPCID.Zombie, NPCID.BaldZombie, NPCID.SlimedZombie, NPCID.SwampZombie, NPCID.TwiggyZombie, NPCID.ZombieRaincoat, NPCID.PincushionZombie);

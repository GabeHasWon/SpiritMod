...
internal class GlobalNPCLoot : GlobalNPC
{
	...
	public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
	{
		...
		DropLoot(npcLoot, 50, 50, ModContent.ItemType<Flying_Fish_Fin>(), npc, NPCID.FlyingFish);
		...
		DropLoot(npcLoot, 1, 1, ModContent.ItemType<RuneWizardScroll>(), npc, NPCID.RuneWizard);
		...
		DropLoot(npcLoot, 200, 200, ModContent.ItemType<ContentItems.Sets.GunsMisc.Swordsplosion.Swordsplosion>(), npc, NPCID.RustyArmoredBonesAxe, NPCID.RustyArmoredBonesFlail, 
			NPCID.RustyArmoredBonesSword, NPCID.RustyArmoredBonesSwordNoArmor, NPCID.BlueArmoredBones, NPCID.BlueArmoredBonesMace, NPCID.BlueArmoredBonesNoPants, NPCID.BlueArmoredBonesSword, 
			NPCID.HellArmoredBones, NPCID.HellArmoredBonesSpikeShield, NPCID.HellArmoredBonesMace, NPCID.HellArmoredBonesSword);
		...
		DropLoot(npcLoot, 175, 175, ModContent.ItemType<ContentItems.Sets.BowsMisc.Morningtide.Morningtide>(), npc, NPCID.HellArmoredBones, NPCID.HellArmoredBonesSpikeShield, 
		...
		DropLoot(npcLoot, 2, 2, ModContent.ItemType<ContentItems.Material.OldLeather>(), 1, 2, npc, NPCID.Zombie, NPCID.BaldZombie, NPCID.SlimedZombie, NPCID.SwampZombie, 
			NPCID.TwiggyZombie, NPCID.ZombieRaincoat, NPCID.PincushionZombie);
		...
		DropLoot(npcLoot, 15, 15, ModContent.ItemType<ProtectorateBody>(), npc, ModContent.NPCType<PagodaGhostHostile>(), ModContent.NPCType<PagodaGhostPassive>(), 
			ModContent.NPCType<CavernCrawler>(), ModContent.NPCType<Mineroid>());
		DropLoot(npcLoot, 15, 15, ModContent.ItemType<ProtectorateLegs>(), npc, ModContent.NPCType<PagodaGhostHostile>(), ModContent.NPCType<PagodaGhostPassive>(), 
			ModContent.NPCType<CavernCrawler>(), ModContent.NPCType<Mineroid>());

		int[] briarEnemies = [ModContent.NPCType<BlossomHound>(), ModContent.NPCType<ForestWraith>(), ModContent.NPCType<Reachman>(), ModContent.NPCType<ReachObserver>(), 
			ModContent.NPCType<ReachSlime>(), ModContent.NPCType<ThornStalker>()];
		DropLoot(npcLoot, 110, 90, ModContent.ItemType<AnodyneHat>(), npc, briarEnemies);

		HardDropLoot(npcLoot, 300, 300, ModContent.ItemType<SnakeStaff>(), npc, NPCID.Lihzahrd, NPCID.LihzahrdCrawler);
	...
	public static void HardDropLoot(NPCLoot loot, int chance, int expertChance, int itemID, NPC npc, params int[] types)
	{
		if (types.Contains(npc.type))
		{
			LeadingConditionRule rule = new LeadingConditionRule(new Conditions.IsHardmode());

			if (chance != expertChance)
				rule.OnSuccess(ItemDropRule.NormalvsExpert(itemID, chance, expertChance));
			else
				rule.OnSuccess(ItemDropRule.Common(itemID, chance));
